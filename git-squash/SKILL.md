...
Read `squash-policy.md` and `classification-procedure.md`. Run all analysis passes
(Steps 3a–3i) in order, then synthesise into a final classification for each commit.

The full classification procedure is in [`classification-procedure.md`](classification-procedure.md).
