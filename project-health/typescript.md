...
**Quality:**
- [ ] `docs/ARC42STORIES.MD` exists — if missing, offer to create a stub using the typescript ARC42STORIES.MD template from `workspace-init` Step 6b, commit it, and note it needs content
