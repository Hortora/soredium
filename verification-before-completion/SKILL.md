...
| Code compiles | `ide_diagnostics`: 0 errors, or `ide_build_project`: success | "No red underlines in my editor" |
...
| "ide_diagnostics showed no errors" | Did you run `ide_build_project` too? Diagnostics are per-file, build is project-wide |
...
✅ [Run build] [See: exit 0] "Build passes"
   or: ide_build_project → success: true
